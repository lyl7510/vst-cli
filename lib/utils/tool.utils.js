...
const entryFiles = ['index.css', 'index.tsx'];
const entry = {};
const entryList = [];
...
module.exports = {
    entry: entry,
    filePath: filePath,
    cssIncludeList: [path.resolve("./src"), path.resolve("./static"), path.resolve("./node_modules/vst-repository"), path.resolve("./node_modules/element-theme-default")],
